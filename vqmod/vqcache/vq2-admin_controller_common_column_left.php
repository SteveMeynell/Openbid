...
$this->load->language('common/paypal');
			$this->load->model('paypal/paypal');
			$data['paypal_text'] = $this->language->get('paypal_balance');
			$data['paypal_balance'] = $this->model_paypal_paypal->getBalance();
			...
			*/
			...
			if ($this->user->hasPermission('access', 'tool/debuglog')) {
				$tool[] = array(
					'name'	   => $this->language->get('text_debuglog'),
