...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h3><?php echo $text_instructions; ?></h3>
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            <div class="<?php echo $class2; ?>"><strong><?php echo $text_quote1; ?></strong><br /></div>
          </div>
          <div class="row">
            <div class="<?php echo $class2; ?>"><strong><?php echo $text_quote2; ?></strong><br /></div>
          </div>
          <div class="row">
            <div class="<?php echo $class2; ?>"><strong><?php echo $text_quote3; ?></strong><br /></div>
          </div>
        </div>
      </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          <legend><?php echo $text_quote; ?></legend>
