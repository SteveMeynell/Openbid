...
class ControllerCommonColumnRight extends Controller {
	public function index() {
		...
		if ($route == 'auction/category' && isset($this->request->get['path'])) {
		...
		if ($route == 'auction/auction' && isset($this->request->get['auction_id'])) {
			$this->load->model('catalog/auction');

			$layout_id = $this->model_catalog_auction->getAuctionLayoutId($this->request->get['auction_id']);
		}
