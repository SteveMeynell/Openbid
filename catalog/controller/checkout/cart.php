...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasFees() || !empty($this->session->data['vouchers'])) {
...
//debuglog("this should have the correct total : " . $total);
			...
			//debuglog("lets see now... ");
			//debuglog($total_data['total']);
			...
			if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
				...
				//debuglog("Problem could be way back here...");
