  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">
          <?php if($geolocation_option) { ?>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-geolocation"><?php echo $entry_geo_location; ?></label>
              <button type="button" id="button-geolocation" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default" onclick="getLocation()"><i class="fa fa-upload"></i> <?php echo $button_geolocation; ?></button>
              <p id="demo"></p>
            </div>
          <?php } ?>
