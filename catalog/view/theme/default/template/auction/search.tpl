          ...
          <div class="auction-thumb">
            ...
            <div>
              <div class="caption">
                ...
                <p class="price"><?php echo $text_highest_bid . $auction['price']; ?></p>
                <p><?php echo $text_num_bids . $auction['bids']; ?></p>
                <p><?php echo $text_views . $auction['views']; ?></p>
...
$('#button-search').bind('click', function() {
	url = 'index.php?route=auction/search';
