            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-selling" class="form-horizontal">
              ...
              <div class="tab-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td class="col-sm-3">
                            <div class="preview">
                              <p><img src="<?php echo $main_image['thumb']; ?>" name="image" id="image" style="width: 100px; height: 100px;" ></p>
                            </div>
                            ...
                            <input type="hidden" name="uploaded_images[main_image]; ?>" value="<?php echo $main_image['image']; ?>" id="input-images; ?>" />
                          </td>
                          <td>
                          </td>
                        </tr>
                        ...
                        <?php foreach ($auction_images as $auction_image) { ?>
                          <tr id="image-num<?php echo $auction_image['sort_order']; ?>">
                            <td class="text-left">
                              ...
                              <button type="button" id="button-upload" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default btn-block"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
                              <input type="hidden" name="uploaded_images[<?php echo $auction_image['sort_order']; ?>]" value="<?php echo $auction_image['image']; ?>" id="input-images; ?>" />
                            </td>
                            <td class="text-left">
                  ...
                  <fieldset>
                    ...
                    <?php if ($featured_used) { 
                      ...
                      <?php } else { ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <label class="radio-inline">
                              <input type="radio" name="featured_option" value="1" />
                              <?php echo $text_yes; ?>
                            </label>
                            <label class="radio-inline">
                              <input type="radio" name="featured_option" value="0" checked="checked" />
                              <?php echo $text_no; ?>
                            </label>
                          </div>
                        </div>
                    ...
                    <?php if ($carousel_used) { 
                      ...
                      <?php } else { ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <label class="radio-inline">
                              <input type="radio" name="carousel_option" value="1" />
                              <?php echo $text_yes; ?>
                            </label>
                            <label class="radio-inline">
                              <input type="radio" name="carousel_option" value="0" checked="checked" />
                              <?php echo $text_no; ?>
                            </label>
                          </div>
                        </div>
                    ...
                    <?php if ($slideshow_used) { 
                      ...
                      <?php } else { ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <label class="radio-inline">
                              <input type="radio" name="slideshow_option" value="1" />
                              <?php echo $text_yes; ?>
                            </label>
                            <label class="radio-inline">
                              <input type="radio" name="slideshow_option" value="0" checked="checked" />
                              <?php echo $text_no; ?>
                            </label>
                          </div>
                        </div>
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <label class="radio-inline">
                            <input type="radio" name="bolded_option" value="1" />
                            <?php echo $text_yes; ?>
                          </label>
                          <label class="radio-inline">
                            <input type="radio" name="bolded_option" value="0" checked="checked" />
                            <?php echo $text_no; ?>
                          </label>
                        </div>
                      </div>
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <label class="radio-inline">
                            <input type="radio" name="highlighted_option" value="1" />
                            <?php echo $text_yes; ?>
                          </label>
                          <label class="radio-inline">
                            <input type="radio" name="highlighted_option" value="0" checked="checked" />
                            <?php echo $text_no; ?>
                          </label>
                        </div>
                      </div>
                    ...
                    <?php } else { ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <label class="radio-inline">
                            <input type="radio" name="social_option" value="1" />
                            <?php echo $text_yes; ?>
                          </label>
                          <label class="radio-inline">
                            <input type="radio" name="social_option" value="0" checked="checked" />
                            <?php echo $text_no; ?>
                          </label>
                        </div>
                      </div>
                  ...
                  <fieldset>
                    <legend><?php echo $text_pricing; ?></legend>
                          ...
                          <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_buy_now_price; ?>"><?php echo $entry_buy_now_price; ?></span></label>
                            <div class="col-sm-6">
                              <label class="text-inline">
                                <input type="number" name="buy_now_price" min="0" value="<?php echo $buy_now_price; ?>"/>
                              </label>
                            </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <label class="text-inline">
                            <input type="number" name="min_bid" min="1" value="<?php echo $min_bid; ?>"/>
                          </label>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <label class="text-inline">
                            <input type="number" name="reserve_bid" min="0" value="<?php echo $reserve_bid; ?>"/>
                          </label>
                        </div>
                      </div>
                  </fieldset>
                      ...
                      <div class="form-group">                    
                        <?php if ($auto_relist_used) { 
                          ...
                          <?php } else { ?>
                            ...
                            <div class="col-sm-2">
                              <label class="radio-inline">
                                <input type="radio" name="auto_relist" value="1" />
                                <?php echo $text_yes; ?>
                              </label>
                              <label class="radio-inline">
                                <input type="radio" name="auto_relist" value="0" checked="checked" />
                                <?php echo $text_no; ?>
                              </label>
                            </div>
                          <?php } ?>
                          <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_num_relist; ?>"><?php echo $entry_num_relist; ?></span></label>
                            <div class="col-sm-6">
                              <label class="text-inline">
                                <input type="number" name="num_relist" min="0" max="<?php echo $max_relists; ?>" value="<?php echo $num_relist; ?>"/>
                              </label>
                            </div>
                        <?php } ?>
                      </div>
                        ...
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_duration; ?>"><?php echo $entry_duration; ?></span></label>
                          <div class="col-sm-4">
                            ...
                            <?php foreach ($auction_durations as $auction_duration) { ?>
                              <?php if ($auction_duration['duration'] == $duration) { ?>
                    ...
                    <legend><?php echo $text_shipping; ?></legend>
                      ...
                      <?php } ?>
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_shipping_cost; ?>"><?php echo $entry_shipping_cost; ?></span></label>
                          <div class="col-sm-6">
                            <label class="text-inline">
                              <input type="number" name="shipping_cost" min="0" value="<?php echo $shipping_cost; ?>"/>
                            </label>
                          </div>
                        </div>
                      <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_international_shipping_cost; ?>"><?php echo $entry_international_shipping_cost; ?></span></label>
                          <div class="col-sm-4">
                            <label class="text-inline">
                              <input type="number" name="international_shipping_cost" min="0" value="<?php echo $international_shipping_cost; ?>"/>
                            </label>
                          </div>
                      </div>
                  </fieldset>
                ...
                <div class="tab-pane" id="tab-confirm">
                  ...
                  <fieldset>
                    <input type="hidden" name="auction_id" value="<?php echo $auctionId; ?>" id="auction-id" />
...
$(document).ready(function() {
  ...
  $.each(categories, function(catNum, category) {
    $('#auction-category' + category.category_id).remove();
		$('#auction-category').append('<div id="auction-category' + category.category_id + '"><i class="fa fa-minus-circle"></i> ' + category.name + '<input type="hidden" name="auction_category[]" value="' + category.category_id + '" /></div>');
  });
...
function PreviewImages(code){
 ...
 <script>
        var photoMain = document.querySelector('#mainimage');
