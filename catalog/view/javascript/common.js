...
var bid = {
	'place': function(auction_id, bid_amount, proxy_amount) {
		$.ajax({
			url: 'index.php?route=checkout/cart/add',
			type: 'post',
			data: 'auction_id=' + auction_id + '&bid_amount=' + bid_amount + '&proxy_amount' + proxy_amount,
			dataType: 'json',
			beforeSend: function() {
	...
	'buynow': function(auction_id, buynow_amount) {
		$.ajax({
			url: 'index.php?route=checkout/cart/add',
			type: 'post',
			data: 'auction_id=' + auction_id + '&bid_amount=' + buynow_amount,
			dataType: 'json',
			beforeSend: function() {
				$('#button-buynow > button').button('loading');
			},
			complete: function() {
				$('#button-buynow > button').button('reset');
			},
			success: function(json) {
				$('.alert, .text-danger').remove();
