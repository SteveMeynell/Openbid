<?php
class ModelToolAuction extends Model {
	...
	public function addAuction($data) {
		...
		if (isset($data['image'])) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "auction_description
							 ...
							 name = '" . $this->db->escape($data['auction_description']['name']) . "',
							 description = '" . $this->db->escape($data['auction_description']['description']) . "',
							 tag = '" . $this->db->escape($data['auction_description']['tag']) . "',
							 meta_title = '" . $this->db->escape($data['auction_description']['meta_title']) . "',
							 meta_description = '" . $this->db->escape($data['auction_description']['meta_description']) . "',
							 meta_keyword = '" . $this->db->escape($data['auction_description']['meta_keyword']) . "'");
