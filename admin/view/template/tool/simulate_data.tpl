  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button id="buttonSimulate" data-toggle="tooltip" onclick="simulate();" title="<?php echo $button_simulate; ?>" class="btn btn-default"><i class="fa fa-upload"></i></button>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $simulate; ?>" method="post" enctype="multipart/form-data" id="form-simulate" class="form-horizontal">
              ...
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                <fieldset>
                  ...
                  <div class="form-radio">
                    <input class="form-radio-input" type="radio" name="simulator" id="user" value="user" checked />
                    <label class="form-radio-label" for="userCheck"><?php echo $entry_users; ?></label>
                  </div>
                  <div class="form-radio">
