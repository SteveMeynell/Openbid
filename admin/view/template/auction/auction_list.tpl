            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'current_bid') { ?>
                    <a href="<?php echo $sort_total; ?>" class="<?php echo strtolower($auction); ?>"><?php echo $column_current_bid; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_total; ?>"><?php echo $column_current_bid; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $auction['current_bid']; ?></td>
