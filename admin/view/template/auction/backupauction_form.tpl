    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="auction" class="nav nav-tabs nav-justified">
            <li class="disabled active"><a href="#tab-auction" data-toggle="tab">1. <?php echo $tab_auction; ?></a></li>
            <li class="disabled"><a href="#tab-options" data-toggle="tab">2. <?php echo $tab_options; ?></a></li>
            <li class="disabled"><a href="#tab-seller" data-toggle="tab">2. <?php echo $tab_seller; ?></a></li>
            <li class="disabled"><a href="#tab-buyer" data-toggle="tab">3. <?php echo $tab_buyer; ?></a></li>
            <li class="disabled"><a href="#tab-payment" data-toggle="tab">3. <?php echo $tab_payment; ?></a></li>
            <li class="disabled"><a href="#tab-bids" data-toggle="tab">4. <?php echo $tab_bids; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab-auction">
              ...
              <div class="text-right">
                <button type="button" id="button-auction" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i> <?php echo $button_continue; ?></button>
              </div>
            </div>
          </div>
          <div class="tab-content">
            <div class="tab-pane" id="tab-options">
              ...
              <div class="text-right">
                <button type="button" id="button-options" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i> <?php echo $button_continue; ?></button>
              </div>
            </div>
          </div>
          <div class="tab-content">
            <div class="tab-seller" id="tab-seller">
            <div class="form-group">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="tab-item">
              ...
              <ul class="nav nav-tabs nav-justified">
                <li class="active"><a href="#tab-item" data-toggle="tab"><?php echo $tab_item; ?></a></li>
                ...
                <div class="tab-pane active" id="tab-item">
                  <fieldset>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="item" value="" id="input-item" class="form-control" />
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('a[href=\'#tab-auction\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
            ...
            <div class="tab-pane" id="tab-payment">
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('a[href=\'#tab-item\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
                <div class="col-sm-6 text-right">
...
$('#button-customer').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: $('#tab-options input[type=\'text\'], #tab-options input[type=\'hidden\'], #tab-options input[type=\'radio\']:checked, #tab-options input[type=\'checkbox\']:checked, #tab-options select, #tab-options textarea'),
		dataType: 'json',
		crossDomain: true,
		beforeSend: function() {
...
$('#button-auction').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/customer&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		data: $('#tab-options input[type=\'text\'], #tab-options input[type=\'hidden\'], #tab-options input[type=\'radio\']:checked, #tab-options input[type=\'checkbox\']:checked, #tab-options select, #tab-options textarea'),
...
$('#tab-item input[name=\'item\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/item/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	'select': function(item) {
		$('#tab-item input[name=\'item\']').val(item['label']);
		$('#tab-item input[name=\'item_id\']').val(item['value']);
