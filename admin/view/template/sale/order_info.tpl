    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              <td class="text-left"><?php echo $column_auction_id; ?></td>
              <td class="text-left"><?php echo $column_name; ?></td>
              <td class="text-left"><?php echo $column_fees; ?></td>
              <td class="text-right"><?php echo $column_num_fees; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $auction['href']; ?>"><?php echo $auction['auction_id']; ?></a></td>
              <td class="text-left"><?php echo $auction['name']; ?></td>
              <td class="text-left">
