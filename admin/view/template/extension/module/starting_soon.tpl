  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-starting-soon" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-starting-when"><?php echo $entry_starting_when; ?></label>
            <div class="col-sm-4">
              <select name="starting_when" id="input-starting-when" class="form-control">
                <?php if ($starting_when) { ?>
            ...
            <label class="col-sm-2 control-label" for="input-length"><?php echo $entry_length; ?></label>
            <div class="col-sm-4">
