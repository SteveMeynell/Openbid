...
class ControllerInstallStep3 extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_OPENBID . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_OPENBID . '\');' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_OPENBID . 'catalog/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_OPENBID . 'system/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_OPENBID . 'image/\');' . "\n";			
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_OPENBID . 'catalog/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_OPENBID . 'catalog/view/theme/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_OPENBID . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_OPENBID . 'system/storage/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_OPENBID . 'system/storage/download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_OPENBID . 'system/storage/logs/\');' . "\n";
			$output .= 'define(\'DIR_MODIFICATION\', \'' . DIR_OPENBID . 'system/storage/modification/\');' . "\n";
			$output .= 'define(\'DIR_UPLOAD\', \'' . DIR_OPENBID . 'system/storage/upload/\');' . "\n\n";
			...
			$file = fopen(DIR_OPENBID . 'config.php', 'w');
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_OPENBID . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_OPENBID . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_OPENBID . 'admin/\');' . "\n";
			$output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_OPENBID . '\');' . "\n\n";

			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_OPENBID . 'admin/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_OPENBID . 'system/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_OPENBID . 'image/\');' . "\n";			
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_OPENBID . 'admin/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_OPENBID . 'admin/view/template/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_OPENBID . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_OPENBID . 'system/storage/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_OPENBID . 'system/storage/download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_OPENBID . 'system/storage/logs/\');' . "\n";
			$output .= 'define(\'DIR_MODIFICATION\', \'' . DIR_OPENBID . 'system/storage/modification/\');' . "\n";
			$output .= 'define(\'DIR_UPLOAD\', \'' . DIR_OPENBID . 'system/storage/upload/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG\', \'' . DIR_OPENBID . 'catalog/\');' . "\n\n";
			...
			$file = fopen(DIR_OPENBID . 'admin/config.php', 'w');
	...
	private function validate() {
		...
		if (!is_writable(DIR_OPENBID . 'config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_OPENBID . 'config.php!';
		}

		if (!is_writable(DIR_OPENBID . 'admin/config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_OPENBID . 'admin/config.php!';
		}
