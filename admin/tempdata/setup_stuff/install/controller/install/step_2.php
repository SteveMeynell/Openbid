...
class ControllerInstallStep2 extends Controller {
	...
	public function index() {
		...
		$data['config_catalog'] = DIR_OPENBID . 'config.php';
		$data['config_admin'] = DIR_OPENBID . 'admin/config.php';
		
		$data['image'] = DIR_OPENBID . 'image';
		$data['image_cache'] = DIR_OPENBID . 'image/cache';
		$data['image_catalog'] = DIR_OPENBID . 'image/catalog';
		$data['image_catalog_auctions'] = DIR_OPENBID . 'image/catalog/auctions';
