...
//$_['text_return']                  = 'Returns NOT NEEDED';
...
$_['text_mail_order']              = 'Orders WHAT IS THIS?';
...
//$_['entry_return']                 = 'Return Terms NOT NEEDED';
//$_['entry_return_status']          = 'Return Status NOT NEEDED';
...
$_['help_open']                    = 'Fill in your store\'s opening times. NOT NEEDED';
$_['help_comment']                 = 'This field is for any special notes you would like to tell the customer i.e. Store does not accept cheques. NOT NEEDED';
$_['help_location']                = 'The different store locations you have that you want displayed on the contact us form. NOT NEEDED';
...
//$_['help_product_count']           = 'Show the number of auctions inside the subcategories in the storefront header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!';
...
//$_['help_tax_default']             = 'Use the store address to calculate taxes if customer is not logged in. You can choose to use the store address for the customer\'s shipping or payment address. NOT NEEDED';
//$_['help_tax_customer']            = 'Use the customer\'s default address when they login to calculate taxes. You can choose to use the default address for the customer\'s shipping or payment address. NOT NEEDED';
...
//$_['help_order_status']            = 'Set the default order status when an order is processed. LOOK AT THIS SECTION';
...
//$_['help_stock_warning']           = 'Display out of stock message on the shopping cart page if a product is out of stock but stock checkout is yes. (Warning always shows if stock checkout is no) NOT NEEDED';
...
$_['help_affiliate_auto']          = 'Automatically add commission when each Auction reaches the closed status.';
...
//$_['help_return']                  = 'Forces people to agree to terms before a return can be created. NOT NEEDED';
//$_['help_return_status']           = 'Set the default return status when a return request is submitted. NOT NEEDED';
...
//$_['error_processing_status']      = 'You must choose at least 1 order process status  NOT NEEDED';
//$_['error_complete_status']        = 'You must choose at least 1 order complete status  NOT NEEDED';
