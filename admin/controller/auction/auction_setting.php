...
class ControllerAuctionAuctionSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('auction/auction_setting', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('auction/auction_setting', 'token=' . $this->session->data['token'], true);
