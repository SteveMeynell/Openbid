...
class ControllerAuctionBidIncrements extends Controller {
    ...
    protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('auction/bid_increments', 'token=' . $this->session->data['token'] . $url, true)
		);

		
		$data['add'] = $this->url->link('auction/bid_increments/add', 'token=' . $this->session->data['token'], true);
		$data['delete'] = $this->url->link('auction/bid_increments/delete', 'token=' . $this->session->data['token'], true);
        ...
        foreach($results as $result){
            $data['increments'][] = array(
                ...
                'edit'       => $this->url->link('auction/bid_increments/edit', 'token=' . $this->session->data['token'] . '&increment_id=' . $result['increment_id'] . $url, true)
            );
        }
		...
		$pagination->url = $this->url->link('auction/bid_increments', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    protected function getForm() {
		...
		if (!isset($this->request->get['increment_id'])) {
			$data['action'] = $this->url->link('auction/bid_increments/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('auction/bid_increments/edit', 'token=' . $this->session->data['token'] . '&increment_id=' . $this->request->get['increment_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('auction/bid_increments', 'token=' . $this->session->data['token'] . $url, true);
    ...
    public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('auction/bid_increments', 'token=' . $this->session->data['token'] . $url, true));
		}
