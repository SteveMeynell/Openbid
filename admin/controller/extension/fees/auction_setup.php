...
class ControllerExtensionFeesAuctionSetup extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('fees_auction_setup', $this->request->post);
		...
		if (isset($this->request->post['fees_auction_setup_status'])) {
			$data['fees_auction_setup_status'] = $this->request->post['fees_auction_setup_status'];
		} else {
			$data['fees_auction_setup_status'] = $this->config->get('fees_auction_setup_status');
		}
