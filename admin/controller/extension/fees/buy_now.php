...
class ControllerExtensionFeesBuyNow extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('fees_buy_now', $this->request->post);
		...
		if (isset($this->request->post['fees_buy_now_fee'])) {
			$data['fees_buy_now_fee'] = $this->request->post['fees_buy_now_fee'];
		} else {
			$data['fees_buy_now_fee'] = $this->config->get('fees_buy_now_fee');
		}
		
		if (isset($this->request->post['fees_buy_now_status'])) {
			$data['fees_buy_now_status'] = $this->request->post['fees_buy_now_status'];
		} else {
			$data['fees_buy_now_status'] = $this->config->get('fees_buy_now_status');
		}
